    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-50 px-4 py-12">
      <div className="w-full max-w-md rounded-lg bg-white p-8 shadow-md">
        <div className="mb-6 text-center">
          <h1 className="text-3xl font-bold text-mainPurple">Login</h1>
        ...
        <div className="mt-6 text-center text-sm">
          ...
          <Link href="/register" className="font-medium text-mainPurple hover:opacity-80">
            Register
          </Link>
        </div>
        <div className="mt-2 text-center text-sm">
          <Link href="/forget-password" className="font-medium text-mainPurple hover:opacity-80">
            Forget Password
          </Link>
        </div>
      </div>
