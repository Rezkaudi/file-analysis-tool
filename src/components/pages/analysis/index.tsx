        ...
        jobPosting && (
          <div className="max-w-6xl mx-auto">
            ...
            {jobPosting.status !== 'completed' && <div className='w-full flex items-center justify-center mt-[100px]'>
              <button className="flex px-10 py-3 text-xl items-center gap-2 disabled:cursor-not-allowed rounded-md bg-gradiantPurple font-medium text-white hover:opacity-80 focus:outline-none focus:ring-2 focus:opacity-80 focus:ring-offset-2 disabled:opacity-50"
